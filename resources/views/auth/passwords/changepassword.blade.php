            ...
            <div class="card-body">
              ...
              <form onsubmit="validate(this)" id="change_form" action="{{ route('updatePassword') }}" style="display: table;width: 100%" method="POST">
                ...
                <div style="display: table-row;width: 100%">
                    ...
                    <input required style="width: 100%;display: table-cell" type="text" name="old_pass" id="old_pass" value="">
                        </div>
                    <div style="display: table-row">
                        <label style="display: table-cell" for="">New Password</label>
                        <input minlength="8" required style="width: 100%;display: table-cell" type="text" name="new_pass" id="new_pass" value="">
                    </div>
                    <div style="display: table-row">
                        <label style="display: table-cell" for="">New Confirmation Password</label>
                        <input  required style="width: 100%;display: table-cell" type="text" name="conf_pass" id="conf_pass" value="">
                    </div>
                    <div>
